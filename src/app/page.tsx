...
export default function Home() {
  ...
  const investors = useMemo(() => {
    ...
    return base.map(
      (n, i) => `${n} • ${tag}${(i + 1).toString().padStart(2, '0')}`
    )
  }, [industry])
                ...
                <div className="mt-6" aria-live="polite">
                  <div className="h-[10px] w-full rounded-full bg-[color:var(--surface-2)] overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${((stepIndex + 1) / STEP_MESSAGES.length) * 100}%`,
                      }}
                    />
                  </div>
                        ...
                        >
                          ...
                          <span
                            className={
                              i <= stepIndex
                                ? 'text-base'
                                : 'text-base text-[color:var(--muted, #8b9891)]'
                            }
                          >
                            {msg}
                          </span>
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-[color:var(--muted, #8b9891)] truncate">
                          Pre‑seed/Seed • Ready for DM
                        </p>
                      </div>
